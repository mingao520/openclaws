    ...
    <footer className="hero-glow py-12">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          <div>
            <h4 className="font-semibold text-sm mb-3" style={{ color: 'rgba(255,255,255,0.8)' }}>官方</h4>
          ...
          <div>
            <h4 className="font-semibold text-sm mb-3" style={{ color: 'rgba(255,255,255,0.8)' }}>学习</h4>
            <ul className="space-y-2 text-sm" style={{ color: 'rgba(255,255,255,0.5)' }}>
          ...
          <div>
            <h4 className="font-semibold text-sm mb-3" style={{ color: 'rgba(255,255,255,0.8)' }}>社区</h4>
            <ul className="space-y-2 text-sm" style={{ color: 'rgba(255,255,255,0.5)' }}>
          ...
          <div>
            <h4 className="font-semibold text-sm mb-3" style={{ color: 'rgba(255,255,255,0.8)' }}>云平台</h4>
            <ul className="space-y-2 text-sm" style={{ color: 'rgba(255,255,255,0.5)' }}>
