      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="reveal mb-8 mx-auto max-w-3xl">
          <div className="flex items-start gap-3 px-4 py-3 rounded-xl bg-amber-50 border border-amber-200 text-amber-800 text-sm">
            ...
            <div>
              <span className="font-semibold">安全提醒：</span>近期发现有恶意 Skills 通过 ClawHub 分发，窃取用户数据。安装第三方 Skill 前请务必检查源码，优先使用官方或社区审核的 Skills。
              <a href="https://thehackernews.com/2025/06/341-malicious-clawhub-skills.html" target="_blank" rel="noopener noreferrer" className="ml-1 text-amber-700 underline hover:text-amber-900">详情 ↗</a>
            </div>
          </div>
        </div>
